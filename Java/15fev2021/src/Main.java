...
public class Main {
	...
	public static void main(String[] args) {
		...
		MolecularTest mTest1 = new MolecularTest("Antreou", "May 15, 2020", true, "Nasal", 0.99);
		...
		AntigenTest aTest4 = new AntigenTest("Tsoukkas", "April 4, 2020", false, "Throat", 30);
